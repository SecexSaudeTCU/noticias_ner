...
from noticias_ner.relatorios_tcu.ner_relatorios_tcu import ExtratorEntidadesRelatoriosTCU
...
def extrair_entidades(arquivo, extrator_entidades=ExtratorEntidadesRelatoriosTCU(), arquivo_saida='ner_tcu.xlsx'):
    """
